...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","KJD_SQL","PASSWD"}, \
				{0,-1,"","KJD_UBT","PASSWD"},  {0,-1,"","KJD_ARD","PASSWD"}, \
				{0,-1,"","KJD_LIN","PASSWD"},  {0,-1,"","KJD_AND","PASSWD"}, \
				{0,-1,"","KJD_BT","PASSWD"},  {0,-1,"","KJD_STM","PASSWD"}, \
				{0,-1,"","KJD_JET","PASSWD"},  {0,-1,"","KJD_QT","PASSWD"}, \
